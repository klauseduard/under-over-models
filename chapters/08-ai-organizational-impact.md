...
![AI Failure Mode Response Matrix](../images/ai-failure-mode-response-matrix.svg)

These failure modes create specific organizational design challenges that extend beyond technical implementation. Over-reliance risks manifest when organizations lack sufficient checkpoints for human validation of AI outputs, particularly in high-stakes decisions where automation bias could lead to significant errors. Under-reliance often emerges from organizational cultures that resist change or lack clear frameworks for integrating AI insights into existing decision-making processes. McKinsey (2025) reports that 28% of organizations still treat generative AI insights as "experimental," suggesting that cultural and structural barriers may prevent effective utilization of AI capabilities even when technical implementation succeeds.
...
Jeyaram, R., Ward, R. N., & Santolini, M. (2024). Large language models recover scientific collaboration networks from text. Applied Network Science, 9, 64. https://doi.org/10.1007/s41109-024-00658-8
